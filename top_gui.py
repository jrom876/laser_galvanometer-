...
# # Serial port
# ser = ''
# def use_serial(comport):
#   print("Using serial comms")
#   init_serial(comport)
#
...
#     except:
#         print('Error opening serial port: %s' % (port))
#
# use_serial(COMPORT)
#############################################
root = tk.Tk()
...
XMIN = 1
YMIN = 1
GLOBAL_AMBIENTLIGHT = 0.0
GLOBAL_TARGETS_DETECTED = 0
GLOBAL_BLANKER_PWM  = 0.0
# GLOBAL_LASER = [0,0,0,0]
# GLOBAL_TARGET = [0,0,0,0,0]
GLOBAL_LASER = (0,0,0)
GLOBAL_TARGET = (0,0,0,0,0,0)
CAMERA_VIEW_ANGLE = 110
SCAN_FLAG = 0
TRACK_FLAG = 0
REACT_FLAG = 0
FIRE_FLAG = 0
